...
public class RiddleScript : MonoBehaviour {
	...
	void RiddleList(){
		...
		// Elephant - Move
		riddles.Add(new Riddle("What is the only land mammal that cannot jump?", KeyCode.E, new MoveAction(), 0, audioClip, "It has big ears", "It's the largest living land mammal too"));
		// Map - Jump
		...
		// Owl - Shoot
		riddles.Add(new Riddle("What asks but never answers?", KeyCode.O, new ShootAction(), 4, audioClip, "Who? Who?", "They're a real hoot!"));
	}
